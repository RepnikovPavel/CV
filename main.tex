...
\section{Technical Skills}
  \resumeHeadingListStart{}
    \resumeSectionType{Languages}{:}{C++, Python}
    \resumeSectionType{Frameworks}{:}{Unreal Engine, Unity, Pytorch}
    \resumeSectionType{Libraries}{:}{numpy, pandas, SciPy, PySR, PyClustering, XGBoost, LightGBM,CatBoost,numba, sklearn}
...
\section{Education}
  \resumeHeadingListStart{}
    ...
    \resumeQuadHeading{Lomonosov Moscow State University}{Moscow, Russia}
    {MSc in Physics,Chair of Mathematical Modeling and Computer Science}{2022-2024}

    \resumeQuadHeading{Lomonosov Moscow State University}{Moscow, Russia}
    {BSc in Physics,Chair of Mathematical Modeling and Computer Science}{2018-2022}
